...
' . 'Данные предварительного расчета:' . '
    ...
    ' . 'Площадь помещений: ' . $_POST['area-value'] . ' м2' . '
    ' . 'Тип помещения: ' . $_POST['type-of-house'] . '
    ' . 'Тип ремонта: ' . $_POST['type-of-repair'] . '
    ' . 'Рассчитанная стоимость услуг: ' . $_POST['repair-price'] . '
    ' . 'Рассчитанная стоимость материалов: ' . $_POST['material-price'] . '
    ' . 'Рассчитанная общая стоимость: ' . $_POST['result'];
